...
private:
	...
	void ReorderUpwards(int nd) //insert
	{
	...
	void ReorderDownwards(int nd, int HeapSize) //pop
	{
...
public:
	...
	~AStar();
	void Search();
	void searchCloseNode(int NextClosestNode, vector<Board*>& save);
};
